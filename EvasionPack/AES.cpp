...
void* CAES::Cipher(void* input, int length)
{
...
void* CAES::InvCipher(void* input, int length)
{
	unsigned char* in = (unsigned char*)input;
	int i;
	for (i = 0; i < length; i += 16)
...
void CAES::KeyExpansion(unsigned char* key, unsigned char w[][4][4])
{
	int i, j, r, c;
